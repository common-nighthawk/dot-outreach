...
nnoremap <Leader>s :edit /Users/daniel/outreach/server/db/seeds_master.rb<CR>
...
" cd ~/.vim/bundle && git clone git://github.com/thoughtbot/vim-rspec.git
" cd ~/.vim/bundle && git clone git://github.com/jgdavey/tslime.vim.git
